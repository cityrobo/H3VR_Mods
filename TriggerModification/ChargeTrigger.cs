...
namespace Cityrobo
{
    public class ChargeTrigger : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenScripts2.ChargeTrigger newComp = gameObject.AddComponent<OpenScripts2.ChargeTrigger>();
            newComp.FireArm = FireArm;
            newComp.ChargeTime = ChargeTime;
            newComp.ChargesUpEveryShot= ChargesUpEveryShot;

            newComp.ChargingSounds = ChargingSounds;
            newComp.ChargingAbortSounds = ChargingAbortSounds;
