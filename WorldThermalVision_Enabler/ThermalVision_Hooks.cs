...
namespace Cityrobo
{
    public class ThermalVision_Hooks
    {
        ...
        {
            ThermalVision_Hooks.sosig_tempDist = temperatureData.sosig_tempDist;
            ThermalVision_Hooks.sosig_maxTemp = temperatureData.sosig_maxTemp;
            ThermalVision_Hooks.sosig_minTemp = temperatureData.sosig_minTemp;

            ThermalVision_Hooks.physicalObject_tempDist = temperatureData.physicalObject_tempDist;
            ThermalVision_Hooks.physicalObject_maxTemp = temperatureData.physicalObject_maxTemp;
            ThermalVision_Hooks.physicalObject_minTemp = temperatureData.physicalObject_minTemp;
        }
