...
namespace Cityrobo
{
    public class RevolverFireNChambersBack : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenScripts2.RevolverFireNChambersBack newComponent = gameObject.AddComponent<OpenScripts2.RevolverFireNChambersBack>();
            newComponent.ModifiedRevolver = revolver;
            newComponent.NChambersBack = NChambersBack;
            newComponent.SecondMuzzle = SecondMuzzle;
            newComponent.FiringDelay = FiringDelay;
