...
namespace Cityrobo
{
    public class MuzzleEffectController : MonoBehaviour
    {
		...
		public void Awake()
        {
            ...
            OpenScripts2.MuzzleEffectController newComponent = gameObject.AddComponent<OpenScripts2.MuzzleEffectController>();
            newComponent.FireArm = FireArm;
            newComponent.MuzzleEffects = MuzzleEffects;
			newComponent.SupressorChangesSize = SupressorChangesSize;
			newComponent.SuppressedMuzzleEffectSizes = SuppressedMuzzleEffectSizes;
