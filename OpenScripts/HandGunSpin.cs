...
namespace Cityrobo
{
    public class HandGunSpin : MonoBehaviour
    {
		...
		public void Awake()
        {
            ...
            OpenScripts2.HandgunSpin newComponent = gameObject.AddComponent<OpenScripts2.HandgunSpin>();
            newComponent.Handgun = handgun;
            newComponent.PoseSpinHolder = PoseSpinHolder;
