...
namespace Cityrobo
{
    public class FireModeAttachment : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenScripts2.FireModeAttachment newComponent = gameObject.AddComponent<OpenScripts2.FireModeAttachment>();
            newComponent.Attachment = attachment;

            newComponent.FireSelectorModeTypes = FireSelectorModeTypes;
            newComponent.BurstAmounts = burstAmounts;

            newComponent.ReplacesExistingFireSelectorModes = !addsSelectorPositions;
            newComponent.SelectorPositions = selectorPositions;
