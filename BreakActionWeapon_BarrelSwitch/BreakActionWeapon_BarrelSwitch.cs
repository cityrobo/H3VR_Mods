...
namespace Cityrobo
{
    public class BreakActionWeapon_BarrelSwitch : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenScripts2.BreakActionWeaponBarrelSwitch newComponent = gameObject.AddComponent<OpenScripts2.BreakActionWeaponBarrelSwitch>();
            newComponent.BreakActionWeapon = breakActionWeapon;
            newComponent.PrimaryBarrelGroupIndex = primaryBarrelGroupIndex;
            newComponent.SecondaryBarrelGroupIndex = secondaryBarrelGroupIndex;

            newComponent.HasFireSelector = hasFireSelector;
            newComponent.FireSelector = fireSelector.transform;
            newComponent.transformType = (OpenScripts2.OpenScripts2_BasePlugin.TransformType) (int) transformType;
            newComponent.TransformAxis = (OpenScripts2.OpenScripts2_BasePlugin.Axis) (int) axis;
            newComponent.FireSelectorInPrimaryMode = primaryMode;
            newComponent.FireSelectorInSecondaryMode = secondaryMode;
