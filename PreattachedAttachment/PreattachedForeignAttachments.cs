...
namespace Cityrobo
{
    public class PreattachedForeignAttachments : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenScripts2.PreattachedForeignAttachments newComponent = gameObject.AddComponent<OpenScripts2.PreattachedForeignAttachments>();
            newComponent.ForeignAttachmentSets = ConvertToSets();
        ...
        private OpenScripts2.PreattachedForeignAttachments.ForeignAttachmentSet[] ConvertToSets()
        {
            OpenScripts2.PreattachedForeignAttachments.ForeignAttachmentSet[] sets = new OpenScripts2.PreattachedForeignAttachments.ForeignAttachmentSet[attachments.Count];

            for (int i = 0; i < attachments.Count; i++)
            {
                sets[i] = new OpenScripts2.PreattachedForeignAttachments.ForeignAttachmentSet(primaryItemIDs[i], backupIDs[i], attachmentPoints[i]);
            }
